...
function UnspentOutput(data) {
  ...
  var amount = !_.isUndefined(data.amount) ? new Unit.fromEMC(data.amount).toSatoshis() : data.satoshis;
...
UnspentOutput.prototype.toObject = UnspentOutput.prototype.toJSON = function toObject() {
  return {
    ...
    amount: Unit.fromSatoshis(this.satoshis).toEMC()
  };
};
